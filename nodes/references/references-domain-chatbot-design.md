...
- 🔑 **Prompting best practices** — Anthropic. https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/claude-prompting-best-practices — Canonical prompt-engineering reference. Sections directly relevant to this graph: "Structure prompts with XML tags," "Long context prompting" (queries-at-the-end can lift quality up to 30%), "Context hydration and role consistency" (the public anchor for [operator-trust-injection](../concepts/operator-trust-injection.md)), "Migrating away from prefilled responses" (Claude 4.6+ removes last-turn prefill).
