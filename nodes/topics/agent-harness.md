...
- **Adapt online (third frame):** neither fixed-dissolve nor fixed-persist — the optimal harness is problem/model-dependent. **Automated Discovery Has No Universally Superior Harness** ([arXiv:2607.18235](https://arxiv.org/abs/2607.18235), 2026-07-20) finds harnesses have a "generalization problem" and argues harness choice is a **tunable hyperparameter** guided by early performance (see [harness-as-hyperparameter](../concepts/harness-as-hyperparameter.md)).
